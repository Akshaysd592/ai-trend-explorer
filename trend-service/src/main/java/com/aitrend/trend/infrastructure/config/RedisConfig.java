 ...
 * Configures Jackson with JavaTimeModule and a resilient CacheErrorHandler
 * that gracefully falls back to PostgreSQL on any cache error.
 */
@Configuration
@EnableCaching
    ...
    public CacheErrorHandler errorHandler() {
        return new CacheErrorHandler() {
            ...
            public void handleCacheGetError(RuntimeException exception, Cache cache, Object key) {
                log.warn("Redis Cache GET error on cache '{}', key '{}'. Falling back to database: {}",
